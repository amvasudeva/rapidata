...
def main():
    ...
    #blueprint_name = configuration.get('DEFAULT','CLOUD') + '_' + configuration.get('DEFAULT','OS') + '_JDK_' + configuration.get('DEFAULT','JDK_VERSION') + '_' + configuration.get('DEFAULT','WEB_SERVER')  + '_' + configuration.get('DEFAULT','WEB_SERVER_VERSION')  + '_' + configuration.get('DEFAULT','APPLICATION_NAME')  + '_' + configuration.get('DEFAULT','PROJECT_NAME') 
    blueprint_name = 'pet-demo' 

    application_name = configuration.get('DEFAULT','APPLICATION_NAME')  + '_' + configuration.get('DEFAULT','PROJECT_NAME') 
